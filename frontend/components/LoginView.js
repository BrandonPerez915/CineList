const loginSheet = new CSSStyleSheet();
loginSheet.replaceSync(`
  :host {
    display: block;
...
class LoginView extends HTMLElement {
  constructor() {
    ...
    this.shadowRoot.adoptedStyleSheets = [loginSheet];
  }
  ...
  connectedCallback() {
    this.shadowRoot.innerHTML = `
      <div class="glass-card">
        ...
        <button class="login-btn" id="btn-entrar">Entrar</button>
        <div class="footer">
    ...
    const btnEntrar = this.shadowRoot.getElementById('btn-entrar');
